...
def expr_venda_liquida_rca(periodo):
    ...
    return (
        ...
        f" - CALCULATE(SUM(FATURAMENTO_DEVOLUCAO[VLDEVOLUCAO]), FILTER(FATURAMENTO_DEVOLUCAO, {f_d}))"
        f" - CALCULATE(SUM(FATURAMENTO_DEVOLUCAO_AVULSA[VLDEVOLUCAO]), FILTER(FATURAMENTO_DEVOLUCAO_AVULSA, {f_da})))"
    )
...
SUMMARIZECOLUMNS(
    ...
    "Devol", SUM(FATURAMENTO_DEVOLUCAO[VLDEVOLUCAO]),
...
SUMMARIZECOLUMNS(
    ...
    "DevolA", SUM(FATURAMENTO_DEVOLUCAO_AVULSA[VLDEVOLUCAO]),
    ...
    if filtros_complexos_drill:
        ...
        def _venda_lucro_mes_dax(a, m):
            ...
            q = f"""EVALUATE {{(
                ...
                CALCULATE(SUM(FATURAMENTO_DEVOLUCAO[VLDEVOLUCAO]), FILTER(FATURAMENTO_DEVOLUCAO, {fd_mes})),
                CALCULATE(SUM(FATURAMENTO_DEVOLUCAO_AVULSA[VLDEVOLUCAO]), FILTER(FATURAMENTO_DEVOLUCAO_AVULSA, {fda_mes})),
